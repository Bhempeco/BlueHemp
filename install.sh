...
echo 'alias bluehemp="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/Bhempeco/BlueHemp" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/Bhempeco/BlueHemp'"
...
rm -rf "$HOME/.config/@bluehemp"
rm -rf "$HOME/.config/@bluehemp"
rm -rf "$HOME/.config/bluehemp-core"
